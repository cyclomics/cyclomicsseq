...
class TestGetQueryPositions(unittest.TestCase):
    def test_deletion(self):
        ...
        self.assertEqual(
            target.VCF_file.get_query_positions("ATG", "A", 1), test_params1_result
        )
    ...
    def test_snp(self):
        ...
        self.assertEqual(
            target.VCF_file.get_query_positions("ATG", "GTA", 3), test_params3_result
        )
...
class TestEnsemblVep(unittest.TestCase):
    ...
    def test_api_real(self):
        ...
        test_query1_result = {
            ...
            "colocated_variants": [
                {
                    ...
                    "end": 114713908,
                    "seq_region_name": "1",
                    "var_synonyms": {"COSMIC": ["COSM584"]},
                },
                {
                    "var_synonyms": {"COSMIC": ["COSM583"]},
                    "seq_region_name": "1",
                    "somatic": 1,
                    "phenotype_or_disease": 1,
                    "strand": 1,
                ...
                },
                {
                    ...
                    "somatic": 1,
                    "seq_region_name": "1",
                    "var_synonyms": {"COSMIC": ["COSM5044298"]},
                    "allele_string": "COSMIC_MUTATION",
                    "id": "COSV54747786",
                },
                {
                    ...
                    "clin_sig_allele": "C:likely_pathogenic;A:pathogenic;G:likely_pathogenic;A:likely_pathogenic;C:pathogenic;G:pathogenic",
                },
            ],
            "transcript_consequences": [
                {
                    ...
                    "cdna_end": 313,
                    "gene_symbol": "NRAS",
                    "hgvsp": "ENSP00000358548.4:p.Gln61Arg",
                    "codons": "cAa/cGa",
                    "gene_symbol_source": "HGNC",
                    "cds_end": 182,
                    "hgvsc": "ENST00000369535.5:c.182A>G",
                    "cdna_start": 313,
                    "strand": -1,
            ...
            "variant_class": "SNV",
            "input": "1 114713908 114713908 T/C 1",
            "allele_string": "T/C",
            "start": 114713908,
            "seq_region_name": "1",
        }
