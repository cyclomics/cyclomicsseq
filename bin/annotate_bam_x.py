...
def read_getter_bam_f5(seqsum_path, in_bam_path, out_bam_path, split_queryname=True):
    # Initialize file handles
    in_bam_file = pysam.AlignmentFile(in_bam_path, "rb")
    hss, seqsum, seqsum_indexes = load_seqsum(seqsum_path)
...
file_out = sys.argv[3]
# file_out = 'testing'
pore_time_aln = read_getter_bam_f5(file_seqsum, file_bam, file_out)
